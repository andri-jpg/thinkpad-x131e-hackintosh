 ...
 *
 * Disassembly of SSDT-CPUPM.aml, Fri Nov  3 12:32:26 2023
 *
...
DefinitionBlock ("", "SSDT", 1, "APPLE ", "CpuPm", 0x00021500)
{
    ...
    Scope (\_PR.CPU0)
    {
        ...
        {
            Store ("ssdtPRGen version.....: 21.5 / macOS 11.7.10 (20G1427)", Debug)
            Store ("custom mode...........: 1", Debug)
            Store ("host processor........: Intel(R) Core(TM) i3-3227U CPU @ 1.90GHz", Debug)
            Store ("target processor......: i3-3227U", Debug)
            ...
            Store ("packageLength.........: 12", Debug)
            Store ("turboStates...........: 0", Debug)
            Store ("maxTurboFrequency.....: 1900", Debug)
